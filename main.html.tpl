...
Graph of <A HREF="../PTS.html">dependencies</A> generated by <A HREF=
"http://www-sop.inria.fr/croap/personnel/Loic.Pottier/Dependtohtml/README.html"
>Dependtohtml</A>
...
<LI><A HREF="ECC.html">Type-checker for Coq V5.10</A>,
    <A HREF="ExtractECC.html">extraction command</A>
...
<LI><A HREF="CoqV6Beta.html">Type-checker for Coq V6.2 (no delta)</A>,
    <A HREF="ExtractV6Beta.html">extraction command</A>
</UL>
...
If you have ocamlrun (version 2.01), you can try and run the
proof-checker (<A HREF="eccd">bytecode file</A>):
